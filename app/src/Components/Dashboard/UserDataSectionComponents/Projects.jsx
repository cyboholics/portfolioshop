...
import { Divider, Grid, Stack, TextField, Button, Typography, IconButton, Slider, Tooltip } from '@mui/material'
    ...
    return (
        <Paper>
            ...
            <Stack className={classes.stack}
                spacing={0}
                direction='column'>
                {projects.map((project, index) => { return <Project key={index} index={index} type={project.type} imageUrl={project.imageUrl} link={project.link} title={project.title} description={project.description} projects={projects} setProjects={setProjects} /> })}
            </Stack>
